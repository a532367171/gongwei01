...
def training():
    ...
    # 测试图片读取
    image_dir = 'D:\\中水电视频\\train'
    logs_dir = 'zhongshuidian_chuyao_logs'     # 检查点保存路径D:\中水电视频\train
...
if __name__ == '__main__':
     training()
     #eval()
    #freeze_graph('zhongshuidian_chuyao_logs\\model.ckpt-49999','zhongshuidian_chuyao_logs\\pb\\ZSD_chuyao_model_49999_04_27.pb')
    #freeze_graph_test('zhongshuidian_chuyao_logs\\pb\\ZSD_chuyao_model_49999_04_27.pb','data\\test1\\C99607814_1_20190427T143609Z.jpg')
