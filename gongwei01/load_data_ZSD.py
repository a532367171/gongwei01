...
def get_all_files(file_path, is_random=True):
    ...
    for item in os.listdir(file_path):
        ...
        #if item_label == '窑1':  # 窑1标记为'1'
        #    label_list.append(1)
        #    窑1_count += 1
        #elif  item_label == '窑2':  # 窑2标记为'2'
        #    label_list.append(2)
        #    窑2_count += 1
        #elif  item_label == '窑3':  # 窑3标记为'4'
        #    label_list.append(3)
        #    窑3_count += 1
        #elif  item_label == '窑4':  # 窑4标记为'4'
        #    label_list.append(4)
        #    窑4_count += 1
        #elif  item_label == '线1':  # 线1标记为'5'
        #    label_list.append(5)
        #    线1_count += 1
        ##elif  item_label == '线2':  # 线2标记为'6'
        ##    label_list.append(6)
        ##    线2_count += 1
        #elif  item_label == '全':  # 全标记为'7'
        #    label_list.append(7)
        #    全_count += 1
        #else:     # 空标记为'0'
        #    label_list.append(0)
        ...
        #    label_list.append(1)
        #    dog_count += 1
    #print('数据集中有  %d个空,%d个窑1,%d个窑2,%d个窑3,%d个窑4,%d个线1,%d个线2,%d个全.' % (空_count, 窑1_count,窑2_count,窑3_count,窑4_count,线1_count,线2_count,全_count))
    print('数据集中有  %d个空,%d个窑1,%d个窑2,%d个窑3,%d个窑4,%d个线1,%d个全.' % (空_count, 窑1_count,窑2_count,窑3_count,窑4_count,线1_count,全_count))
